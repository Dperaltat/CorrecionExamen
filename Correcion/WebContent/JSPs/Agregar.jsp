...
<center>
	...
	<form action="/Correcion/AgregarVehiculo" method="POST">
	<div class="card-body">
	
		<div class="form-group row">
			<label for="numero" class="col-sm-2 col-form-label">Cédula de Cliente</label>
			<div class="col-sm-10">
				<input class="form-control" type="text" name="cedula" placeholder="Cédula" maxlength="10">
			</div>		
		</div>
		...
		<div class="form-group row">
			...
			<div class="col-sm-10">
				<input class="form-control" type="text" name="placa" placeholder="Placa" maxlength="10">
			</div>		
		</div>
